...
public class TrafficNewActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_traffic_new);

        tabLayout = findViewById(R.id.tab_layout);
        viewPager2 = findViewById(R.id.view_pager2);
        backbutton = findViewById(R.id.backbutton);
        TrafficFragmentAdapter adapter = new TrafficFragmentAdapter(this);
