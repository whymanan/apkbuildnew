...
public class BankActivity2 extends AppCompatActivity {
...
//    private IntentIntegrator qrScan;
    ...
    String bank_code,transactionType,access_token;
...
//        typeadharno();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(transactiontype_.equals("Select Transaction Types")){
                    Toast.makeText(BankActivity2.this, "Please select transaction type", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(BankActivity2.this, BioMetricActivity.class);
                    ...
                    i.putExtra("access_token", access_token.toString());
                    startActivity(i);
                }
            }
        });
        ...
        scan_linear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(BankActivity2.this, ScanActivity.class);
...
//            name.setText(username);
    ...
    public void selectTransactionType(){
        ...
        final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(BankActivity2.this, android.R.layout.simple_spinner_dropdown_item, list);
