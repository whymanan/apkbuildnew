...
public class LandLineNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land_line_new);


        tabLayout = findViewById(R.id.tab_layout);
        viewPager2 = findViewById(R.id.view_pager2);
        backbutton = findViewById(R.id.backbutton);
        LandlineFragmentAdapter adapter = new LandlineFragmentAdapter(this);
